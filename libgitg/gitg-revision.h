...
extern gchar const *gitg_revision_get_author (GitgRevision *revision);
extern gchar const *gitg_revision_get_author_email (GitgRevision *revision);
extern gint64 gitg_revision_get_author_date (GitgRevision *revision);

extern gchar const *gitg_revision_get_committer (GitgRevision *revision);
extern gchar const *gitg_revision_get_committer_email (GitgRevision *revision);
extern gint64 gitg_revision_get_committer_date (GitgRevision *revision);

extern gchar const *gitg_revision_get_subject (GitgRevision *revision);

extern gchar const *gitg_revision_get_hash (GitgRevision *revision);
extern GitgHash *gitg_revision_get_parents_hash (GitgRevision *revision, guint *num_parents);
